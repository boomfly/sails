...
module.exports = function (handshake) {
	...
	if (!handshake[SDK_META_PARAMS.version]) {
		handshake[SDK_META_PARAMS.version] = '0.9.0';
	}

	return {
		version: handshake[SDK_META_PARAMS.version],
		platform: handshake[SDK_META_PARAMS.platform],
		language: handshake[SDK_META_PARAMS.language]
	};
};
